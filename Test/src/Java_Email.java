...
public class Java_Email
{
	...
	public static ArrayList stats(String host,String user,String password,String name) throws MessagingException, GeneralSecurityException {
		Properties properties = new Properties();
